...
import org.example.demo2024.util.WebSocketUtil;
...
/**
 * @program: demo2024
 * @description: CustomizeLifeCycleLinstener
 * @author: 作者名
 * @create: 2024/02/06
 */
@Component
@Slf4j
@Data
public class MyWSLifeCycle implements SmartLifecycle {
    ...
    public boolean isRunning() {
        log.info("--isRunning-:{}",isRunningFlag());
        // 默认返回false
